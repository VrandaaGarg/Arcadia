              ...
              <table className="w-full border-collapse min-w-[300px]">
                <thead>
                  <tr className="bg-purple-800/50">
                    ...
                    <th className="p-3 md:p-4 text-right text-sm md:text-base">
                      Score
                    </th>
                  </tr>
                </thead>
                <tbody>
                  {leaderboard.slice(3).map((player, index) => (
                    ...
                    >
                      <td className="p-3 md:p-4 text-gray-300 text-sm md:text-base">
                        {index + 4}
                      </td>
                      ...
                      <td className="p-3 md:p-4 text-right font-bold text-purple-400 text-sm md:text-base">
                        {player.score}
                      </td>
                    </motion.tr>
                  ))}
